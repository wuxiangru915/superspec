 ...
 *
 * Supported AI coding platforms, mirroring Superspec's AI_TOOLS config.
 * Reference: Superspec/src/core/config.ts
 */
...
export interface Platform {
  ...
  /** Hook configuration format. Determines how installSuperspecHooksForPlatform writes the hook config. */
